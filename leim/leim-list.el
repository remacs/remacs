...
(register-input-method
 ...
 (quote ("$(3$O#U!.(B " (ethio-prefer-ascii-space "_" "$(3$h(B") (ethio-prefer-ascii-punctuation "." "$(3$i(B"))) "  KEYS AND FUNCTIONS"
 "quail/ethiopic")
(register-input-method
...
(register-input-method
 ...
 "1<" "Latin-1 characters input method with postfix modifiers"
 "quail/latin-post")
(register-input-method
 "latin-2-postfix" "Latin-2" 'quail-use-package
 "2<" "Latin-2 characters input method with postfix modifiers"
 "quail/latin-post")
(register-input-method
 "latin-3-postfix" "Latin-3" 'quail-use-package
 "3<" "Latin-3 characters input method with postfix modifiers"
 "quail/latin-post")
(register-input-method
...
(register-input-method
 ...
 "FI<" "Finnish (Suomi) input method (rule: AE -> ,AD(B, OE -> ,AV(B)"
 "quail/latin-post")
(register-input-method
...
(register-input-method
 ...
 "DE<" "German (Deutsch) input method (rule: AE -> ,AD(B, OE -> ,AV(B, UE -> ,A\(B, sz -> ,A_(B)"
 "quail/latin-post")
(register-input-method
...
(register-input-method
 ...
 "SC<" "Scandinavian input method (rule: AE->,AD(B/,AF(B, OE->,AV(B/,AX(B, AA->,AE(B, E'->,AI(B)"
 "quail/latin-post")
(register-input-method
...
(register-input-method
 ...
 "$(CGQ1[=I9z@T7BG%(B" "$(CGQ1[=I9z@T7BG%(B:"
 "quail/symbol-ksc")
(register-input-method
 "korean-hanja-jis" "Korean" 'quail-use-package
 "$(C9z$B4A(B" "2$(C9z=D(BJIS$B4A;z(B: $B3:aD$(CGO4B(B $B4A;z$(C@G(B $B1$$(C@;(B $(CGQ1[(B2$(C9z$B<0$(C@87N(B $B8F=P$(CGO?)(B $BA*Z$(B"
 "quail/hanja-jis")
(register-input-method
