...
(let ((tbl (standard-case-table)))
  (set-case-syntax-pair ?Ð ?Ñ‘ tbl)
  (set-case-syntax-pair ?Ð‚ ?Ñ’ tbl)
  (set-case-syntax-pair ?Ðƒ ?Ñ“ tbl)
  (set-case-syntax-pair ?Ð„ ?Ñ” tbl)
  (set-case-syntax-pair ?Ð… ?Ñ• tbl)
  (set-case-syntax-pair ?Ð† ?Ñ– tbl)
  (set-case-syntax-pair ?Ð‡ ?Ñ— tbl)
  (set-case-syntax-pair ?Ðˆ ?Ñ˜ tbl)
  (set-case-syntax-pair ?Ð‰ ?Ñ™ tbl)
  (set-case-syntax-pair ?ÐŠ ?Ñš tbl)
  (set-case-syntax-pair ?Ð‹ ?Ñ› tbl)
  (set-case-syntax-pair ?ÐŒ ?Ñœ tbl)
  (set-case-syntax-pair ?ÐŽ ?Ñž tbl)
  (set-case-syntax-pair ?Ð ?ÑŸ tbl)
  (set-case-syntax-pair ?Ð ?Ð° tbl)
  (set-case-syntax-pair ?Ð‘ ?Ð± tbl)
  (set-case-syntax-pair ?Ð’ ?Ð² tbl)
  (set-case-syntax-pair ?Ð“ ?Ð³ tbl)
  (set-case-syntax-pair ?Ð” ?Ð´ tbl)
  (set-case-syntax-pair ?Ð• ?Ðµ tbl)
  (set-case-syntax-pair ?Ð– ?Ð¶ tbl)
  (set-case-syntax-pair ?Ð— ?Ð· tbl)
  (set-case-syntax-pair ?Ð˜ ?Ð¸ tbl)
  (set-case-syntax-pair ?Ð™ ?Ð¹ tbl)
  (set-case-syntax-pair ?Ðš ?Ðº tbl)
  (set-case-syntax-pair ?Ð› ?Ð» tbl)
  (set-case-syntax-pair ?Ðœ ?Ð¼ tbl)
  (set-case-syntax-pair ?Ð ?Ð½ tbl)
  (set-case-syntax-pair ?Ðž ?Ð¾ tbl)
  (set-case-syntax-pair ?ÐŸ ?Ð¿ tbl)
  (set-case-syntax-pair ?Ð  ?Ñ€ tbl)
  (set-case-syntax-pair ?Ð¡ ?Ñ tbl)
  (set-case-syntax-pair ?Ð¢ ?Ñ‚ tbl)
  (set-case-syntax-pair ?Ð£ ?Ñƒ tbl)
  (set-case-syntax-pair ?Ð¤ ?Ñ„ tbl)
  (set-case-syntax-pair ?Ð¥ ?Ñ… tbl)
  (set-case-syntax-pair ?Ð¦ ?Ñ† tbl)
  (set-case-syntax-pair ?Ð§ ?Ñ‡ tbl)
  (set-case-syntax-pair ?Ð¨ ?Ñˆ tbl)
  (set-case-syntax-pair ?Ð© ?Ñ‰ tbl)
  (set-case-syntax-pair ?Ðª ?ÑŠ tbl)
  (set-case-syntax-pair ?Ð« ?Ñ‹ tbl)
  (set-case-syntax-pair ?Ð¬ ?ÑŒ tbl)
  (set-case-syntax-pair ?Ð­ ?Ñ tbl)
  (set-case-syntax-pair ?Ð® ?ÑŽ tbl)
  (set-case-syntax-pair ?Ð¯ ?Ñ tbl))
...
(let ((deflist	'(("àº-àº®"	"w"	?0) ; consonant
