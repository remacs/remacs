...
(put 'languages 'custom-loads '("cus-edit" "info-look" "ada-mode" "asm-mode" "cperl-mode" "dcl-mode" "delphi" "fortran" "hideshow" "icon" "m4-mode" "meta-mode" "modula2" "octave-mod" "pascal" "perl-mode" "prolog" "ps-mode" "sh-script" "simula" "tcl" "vhdl-mode" "sgml-mode"))
...
(put 'tools 'custom-loads '("add-log" "compare-w" "diff" "ediff" "emerge" "gud" "rcompile" "speedbar" "tempo" "tooltip" "vc" "which-func" "copyright" "compile" "etags" "make-mode"))
...
(put 'mail 'custom-loads '("simple" "startup" "ph" "time" "gnus" "message" "emacsbug" "feedmail" "mail-extr" "mail-hist" "mail-utils" "mailalias" "metamail" "mh-e" "mspools" "rmail" "sendmail" "smtpmail" "supercite" "uce" "fortune"))
...
(defvar custom-versions-load-alist '(("20.3.3" "dos-vars") ("20.4" "sh-script" "help" "compile") ("21.1" "sgml-mode" "cus-edit" "simple") ("20.3" "desktop" "easymenu" "hscroll" "dabbrev" "ffap" "rmail" "paren" "mailabbrev" "frame" "uce" "mouse" "diary-lib" "sendmail" "debug" "avoid" "hexl" "vcursor" "vc" "compile" "etags" "octave-mod" "help" "browse-url" "add-log" "find-func" "vc-hooks" "cus-edit" "replace"))
