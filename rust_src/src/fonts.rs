...
use remacs_sys::{fontmod, Qfont_spec, Qfont_entity, Qfont_object};
use lisp::LispObject;
use symbols::intern;
...
impl LispFontRef {
    ...
    pub fn is_font_spec(self) -> bool {
        self.0.pseudovector_size() == fontmod::FONT_SPEC_MAX as i64
    }

    pub fn is_font_entity(self) -> bool {
        self.0.pseudovector_size() == fontmod::FONT_ENTITY_MAX as i64
    }

    pub fn is_font_object(self) -> bool {
        self.0.pseudovector_size() == fontmod::FONT_OBJECT_MAX as i64
    }
}
