...
use crate::remacs_sys::{backtrace_debug_on_exit, build_string, call_debugger, check_cons_list,
                        do_debug_on_call, eval_sub, find_symbol_value, funcall_lambda,
                        funcall_subr, globals, list2, maybe_gc, maybe_quit, record_in_backtrace,
                        record_unwind_protect, record_unwind_save_match_data, specbind, unbind_to,
                        COMPILEDP, MODULE_FUNCTIONP};
use crate::remacs_sys::{pvec_type, EmacsInt, Lisp_Compiled};
use crate::remacs_sys::{Fapply, Fcons, Fdefault_value, Ffset, Fload, Fpurecopy};
use crate::remacs_sys::{QCdocumentation, Qautoload, Qclosure, Qerror, Qexit, Qfunction,
                        Qinteractive, Qinteractive_form, Qinternal_interpreter_environment,
                        Qinvalid_function, Qlambda, Qmacro, Qnil, Qrisky_local_variable, Qsetq,
                        Qt, Qunbound, Qvariable_documentation, Qvoid_function,
                        Qwrong_number_of_arguments};
use remacs_macros::lisp_fn;

use crate::remacs_sys::{Vautoload_queue, Vrun_hooks};

use crate::data::{defalias, indirect_function, indirect_function_lisp, set, set_default};
use crate::lisp::{defsubr, is_autoload};
use crate::lisp::{LispObject, LispSubrRef};
use crate::lists::{assq, car, cdr, get, memq, nth, put, Fcar, Fcdr, LispCons};
use crate::multibyte::LispStringRef;
use crate::obarray::loadhist_attach;
use crate::objects::equal;
use crate::symbols::{fboundp, symbol_function, LispSymbolRef};
